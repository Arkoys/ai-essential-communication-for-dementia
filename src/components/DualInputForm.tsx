...
export function DualInputForm({
  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      >
        <div className="relative flex flex-1 items-center min-w-0 bg-white dark:bg-zinc-900 rounded-2xl shadow-sm transition-all border border-zinc-300 dark:border-zinc-700 focus-within:ring-2 focus-within:ring-purple-500/20 focus-within:border-purple-500">
          <input
            type="text"
            value={input}
